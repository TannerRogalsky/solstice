...
pub(crate) fn generate_enum_semantics_impl(
        ...
        match field {
            Ok(field) => {
                ...
                let field_gen = quote! {
                  ...
                  impl graphics::vertex::HasSemantics for #ty_name {
                    type Sem = #ident;
                  ...
                  unsafe impl graphics::vertex::VertexAttrib for #ty_name {
                    const VERTEX_ATTRIB_DESC: graphics::vertex::VertexAttribDesc =
                      <#repr_ty_name as graphics::vertex::VertexAttrib>::VERTEX_ATTRIB_DESC;
                  }
                };
    ...
    let output_gen = quote! {
      impl graphics::vertex::Semantics for #ident {
        fn index(&self) -> usize {
          *self as usize
        }
        ...
        fn semantics_set() -> Vec<graphics::vertex::SemanticsDesc> {
          vec![#(#semantics_set,)*]
        }
      }
